...
execute store result entity @s Motion[0] double 0.008 run scoreboard players operation @s fws.motion_x2 -= @s fws.motion_x1
execute store result entity @s Motion[1] double 0.001 run scoreboard players operation @s fws.motion_y2 -= @s fws.motion_y1
execute store result entity @s Motion[2] double 0.008 run scoreboard players operation @s fws.motion_z2 -= @s fws.motion_z1
